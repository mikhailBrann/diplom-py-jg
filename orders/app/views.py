    ...
    def post(self, request, *args, **kwargs):
        ...
        if url:
            ...
            try:
                ...
                return JsonResponse({'Status': False, 'Error': str(e)}, json_dumps_params={'ensure_ascii':False})
            else:
    ...
    def post(self, request, *args, **kwargs):
        ...
        if {'city', 'street', 'phone'}.issubset(request.data):
            ...
            if serializer.is_valid():
                ...
                JsonResponse({'Status': False, 'Errors': serializer.errors}, json_dumps_params={'ensure_ascii': False})
